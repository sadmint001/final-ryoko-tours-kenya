-- Recreate blog_comments with explicit FK to profiles(user_id)
...
CREATE TABLE public.blog_comments (
    ...
    -- Reference public.profiles(user_id) which matches auth.uid()
    ...
    -- Explicitly name the constraint to avoid Join ambiguity
    CONSTRAINT fk_blog_comments_profile 
        FOREIGN KEY (user_id) 
